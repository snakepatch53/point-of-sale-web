...
function SectionSale() {
    ...
    const iva = (subtotal * entity?.tax) / 100;
            ...
            <div className=" scroll-style overflow-x-auto ">
                <table className="w-full text-center">
                    ...
                    <tfoot className=" font-bold text-[--c3-txt2] uppercase ">
                        ...
                        <tr>
                            <td colSpan="2"></td>
                            <td className="font-sans">TAX ({entity?.tax}%):</td>
...
function SectionProductItem({
    ...
    return (
        <button
            className="flex gap-2 p-3 bg-[--c3] rounded-md cursor-pointer transition-all hover:scale-[1.03] hover:shadow-lg"
            onClick={onClick}
        >
