...
export default function Sidebar() {
    ...
    return (
        <div
            className={cls(
                "panel-sidebar-component fixed z-[500] left-0 flex flex-col items-center w-[200px] min-w-[200px] h-full p-[10px] overflow-y-auto overflow-x-hidden bg-[--c4] backdrop-blur-md shadow-lg",
        ...
        >
            ...
            <Option name="Productos" icon={faStore} to="./products" />
...
function Option({ name, icon, to }) {
    ...
    const isActive = pathname.includes(to.split("./")[1]);
    const { isOpen: IsOpenSidebar } = useContext(SidebarContext);
    return (
        <Link
            className={cls(
